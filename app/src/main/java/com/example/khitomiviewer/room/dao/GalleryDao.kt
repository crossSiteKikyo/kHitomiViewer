...
interface GalleryDao {
  ...
  fun findLikeOrderByLikeStatusChangedAt(limit: Int, offset: Long): List<Gallery>

  @Query("select * from gallery where likeStatus = 2 order by gId desc limit :limit offset :offset")
  fun findLikeOrderBygId(limit: Int, offset: Long): List<Gallery>
  ...
  fun findDislikeOrderByLikeStatusChangedAt(limit: Int, offset: Long): List<Gallery>

  @Query("select * from gallery where likeStatus = 0 order by gId desc limit :limit offset :offset")
  fun findDislikeOrderBygId(limit: Int, offset: Long): List<Gallery>
